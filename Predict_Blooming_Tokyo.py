...
def make_prediction(path_data, n_days, year, test_yes_no, only_start):
    if n_days==10:
        model_path = r'C:\Users\annam\.spyder-py3\WeiterbildungDataScience\Python\Projekt1Sakura\Projekt2\Projekt3\ProjektSakura_Refactored\GBreg_retrained_10.sav'
    else:
        model_path = r'C:\Users\annam\.spyder-py3\WeiterbildungDataScience\Python\Projekt1Sakura\Projekt2\Projekt3\GB_model_30.sav'
    model_temp = pd.read_pickle(model_path)
    if only_start==True:
        model_nn = keras.models.load_model(r'C:\Users\annam\.spyder-py3\WeiterbildungDataScience\Python\Projekt1Sakura\Projekt2\Projekt3\ProjektSakura_Refactored\Tokyo_NN_start.h5')
    else:
        model_nn = keras.models.load_model(r'C:\Users\annam\.spyder-py3\WeiterbildungDataScience\Python\Projekt1Sakura\Projekt2\Projekt3\ProjektSakura_Refactored\Tokyo_NN.h5')
    if test_yes_no==True:
...
# make_prediction(path_data, 30)    

# if __name__ == '__main__':
#     path=r"C:\Users\annam\.spyder-py3\WeiterbildungDataScience\Python\Projekt1Sakura\Projekt2\Projekt3\ProjektSakura_Refactored\tokyo_sakura.csv"
#     start_year = 2010
#     end_year = 2019
#     for year in range(start_year, end_year+1):
#         prediction = make_prediction(path, 10,year) 
#         print(str(year)+" : ")
#         print(prediction)
#         print()
#     # prediction = make_prediction(path, 10,2018) 
#     #     # print(str(year)+" : ")
#     # print(prediction)
#     print("All done!")
...
if __name__ == '__main__':
    ...
    path=r"C:\Users\annam\.spyder-py3\WeiterbildungDataScience\Python\Projekt1Sakura\Projekt2\Projekt3\ProjektSakura_Refactored\tokyo_2022.csv"
